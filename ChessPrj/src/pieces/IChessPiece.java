...
public interface IChessPiece {
     ...
     * "Queen", "Rook", etc.).  Note:  In this case
     * "type" refers to the game
    ...
    ArrayList<Move> possibleMoves(int r,
                                  int c,
                                  IChessPiece[][] board);
    /**
     ...
     * {@code this} object must be the piece at
     * location {@code [move.fromRow, move.fromColumn]}.
     * (This method makes no sense otherwise.)
     *
     * @param move  a {@link W18project3.Move} object
     *             describing the move to be made.
     * @param board the {@link W18project3.IChessBoard}
     *              in which this piece resides.
     * @return {@code true} if the proposed move is
     * valid, {@code false} otherwise.
     * @throws IndexOutOfBoundsException if either
     * {@code [move.fromRow, move.fromColumn]}
     * or {@code [move.toRow,move.toColumn]}
     * don't represent valid locations on the board.
     * @throws IllegalArgumentException  if {@code this}
     * object isn't the piece at location {@code
